...
import { Footer, Header, PhoneField, PrivacyConsent } from "./AventoSite";
...
const steps = [
  ["/buyout/step-keys-transparent.png", "Передаєте свій автомобіль", "Надаєте автомобіль і необхідні документи. Усе інше — від оцінки до оформлення договору — виконають наші спеціалісти. Ви заощаджуєте час, кошти й нерви."],
  ["/buyout/step-inspection-transparent.png", "Оцінюємо ваш автомобіль", "У найкоротші строки проведемо професійну оцінку. Увесь процес від надання автомобіля до отримання коштів може зайняти до однієї години."],
  ["/buyout/step-price-transparent.png", "Пропонуємо найкращу ціну", "Враховуємо стан автомобіля та пропонуємо до 97% його ринкової вартості."],
  ["/buyout/step-contract-transparent.png", "Юридично оформлюємо угоду", "Забезпечуємо надійне оформлення з підписанням договору та оперативним отриманням коштів."],
] as const;
        ...
        <section className="buyout-intro">
          ...
          {submitted ? (
            ...
            <form className="buyout-form" onSubmit={onSubmit}>
              ...
              <PhoneField label="Номер телефону" />
              <PrivacyConsent />
